...
| 模块 | 功能 |
| --- | --- |
| 登录鉴权 | JWT 登录、管理员 / 员工两种角色、接口权限控制 |
| 首页仪表盘 | 管理员看全局统计；员工看本月考勤统计 + 在线打卡 |
| 员工管理 | 员工增删改查、按部门/关键字检索，新增员工自动生成登录账号 |
| 部门管理 | 部门增删改查 |
| 考勤管理 | 员工上/下班打卡、迟到/早退自动判定、管理员补录与查询 |
| 请假管理 | 员工提交请假申请、管理员审批（批准/驳回） |
| 加班管理 | 员工提交加班申请、管理员审批 |
| 薪资规则 | 配置迟到/缺勤/事假扣款、加班费单价、全勤奖 |
| 工资核算 | 按月自动生成工资单：基本工资 + 全勤奖 + 加班费 − 各项扣款 − 简化个税，支持重算与发放 |

---

## 🧰 技术栈

**后端**：Spring Boot 2.7 · Spring Security + JWT · MyBatis-Plus · H2 / MySQL 8 · Java 8
